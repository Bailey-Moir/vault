...
>    *Normally you'd divide by some [[Norms|norm]], but the sum of the [[Components|components]] of an input to $\mathit{A}$ is always equal to the sum of the [[Components|components]] of its output, so scaling isn't an issue.*
