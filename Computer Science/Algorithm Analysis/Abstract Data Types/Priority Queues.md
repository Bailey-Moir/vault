...
tags:
  ...
  - comp
---
A *min/max priority queue* is a type of [[Queues|queue]] that has the same two functions, except the `dequeue()` pops the **minimum/maximum** value.

|                 | $1$ insert            | $1$ remove (min)      | $n$ of each            | *Algorithm*                          |
| --------------- | --------------------- | --------------------- | ---------------------- | ------------------------------------ |
