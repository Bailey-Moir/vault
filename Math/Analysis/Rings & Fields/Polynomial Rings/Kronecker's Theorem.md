...
Then there is an [[Subfields#^extension-field|extension field]] $E$ of $F$ in which $f$ has a root.

> [!proof]-
> Choose an [[Reduciblity#^negation|irreducible factor]] $g(x)$ of $f(x)$ in $F$.
...
=======
>>>>>>> 97a044e (vault backup: 2026-04-29 21:57:30)
[^1]: [[Polynomial Rings]]
