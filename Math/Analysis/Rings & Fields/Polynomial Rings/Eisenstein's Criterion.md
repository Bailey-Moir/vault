...
then $f$ is [[Reduciblity#^negation|irreducible]] over $\Q$.

> [!proof]-
> Let $f \in \Z[x]$ be a polynomial satisfying *Eisenstein's criterion*, and suppose $f$ is [[Reduciblity|reducible]] in $\Q[x]$.
> 
> Then $f = gh$ for some non-[[Rings#^unit|units]] $g,h \in \Z[x]$ of positive degree by [[Reduciblity#^rational-reducible-implies-integer-reducible|this theorem]].
> 
> $$\begin{align}
