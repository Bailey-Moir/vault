...
- every non-zero non-[[Rings#^unit|unit]] can be written in the form $p_{1},p_{2},\dots,p_{n}$, where the $p_{i}$'s are [[Reducible Factors#^negation|irreducible factors]] of positive [[Polynomials#Degree|degree]] and
- if $p_{1},p_{2},\dots,p_{n} = q_{1},q_{2},\dots q_{m}$ where the $p_{i}$'s and $q_{j}$'s are [[Reducible Factors#^negation|irreducible factors]] of $R$ of positive [[Polynomials#Degree|degree]], then $m = n$, and after renumbering the $s_{j}$'s, you have $p_{i}(x) = cq_{i}(x)$.

> [!proof]- Existence
> By [[Strong Induction|strong induction]] on the [[Polynomials#Degree|degree]],
> **Base Case**
> Suppose $\deg f = 1$. Then $f(x) = c(x-a)$ for some $a,c \in \F$, so $f$ is [[Reducible Factors#^negation|irreducible]] by [[Reducible Factors#^field-units-are-constant|this lemma]].
> 
> **Induction Step**
> Let $k \in \N_{>1}$ be given. Suppose every [[Polynomial Rings|polynomial]] of [[Polynomials#Degree|degree]] strictly less than $k$ can be factored into [[Reducible Factors#^negation|irreducible factors]]. Let $f \in \F[x]$ be any [[Polynomial Rings|polynomial ring]] of [[Polynomials#Degree|degree]] $k$.
> 
> If $f$ is [[Reducible Factors#^negation|irreducible]], then we are done.
> If $f$ is [[Reducible Factors|reducible]], $f(x) = g(x)h(x)$ for some $0 < \deg g < \deg h < \deg f = k$.
> 
> By our induction hypothesis, we can factor g and h into [[Reducible Factors#^negation|irreducible factors]], so we can also factor $f$.
...
> with $\deg p_{i} > 0$ and [[Reducible Factors#^negation|irreducible]].
...
> Since $q_{j}$ is [[Reducible Factors#^negation|irreducible]], we have $\deg p_{1} = \deg q_{j}$, so $p_{1}(x) = cq_{j}(x)$ for some $c \in \F$.
> 
