...
\end{align}$$
Let $p_{1}$ and $p_{2}$ be [[Reduciblity#^negation|irreducible]] factors of some $f_{1} \in F_{1}[x]$ and $f_{2} \in F_{2}[x]$ respectively.
...
Finally, consider $\lambda = \phi \circ \pi : F_{1}[x] \to F_{2}[x] / \left< p_{2}(x) \right>$.
