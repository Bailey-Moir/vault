...
tags:
  ...
  - math
---
A field $\F$ is a [[Sets|set]] with two [[Binary Operations|binary operations]]: +, $\times$ with the properties that:
...
> 0 &= a\times0
> \end{align*}$$
- If $a\in \F$, its additive inverse is $-a= (-1)a$.
> [!proof]-
