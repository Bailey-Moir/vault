...
tags:
  ...
  - discrete
---
[[Vertices]] $u$ and $v$ are *connected* if there is a [[Walks|walk]] from $u$ to $v$. $\gamma$ denotes the [[Equivalence Relations|equivalence relation]] on $V(G)$ where $\left( u,v \right)\in \gamma$ [[Logical Equivalence|iff]] $u$ is *connected* to $v$.
