...
tags:
  ...
  - discrete
---
A *bridge* is an [[Math/Discrete/Graph Theory/Definitions/Edges|edge]] on a **connected** [[Math/Discrete/Graph Theory/Graphs|graph]] that if removed, results in a **disconnected** [[Math/Discrete/Graph Theory/Graphs|graph]].
- A given [[Math/Discrete/Graph Theory/Definitions/Edges|edge]] is a *bridge* [[Logical Equivalence|iff]] it is not in a [[Walks|cycle]].
> [!proof]-
> Let $e = \{ a,b \}$ be the [[Math/Discrete/Graph Theory/Definitions/Edges|edge]], and $G$ be the connected [[Math/Discrete/Graph Theory/Graphs|graph]].
