...
1. Find $\gcd(a,n)$^[[[Greatest Common Divisor]]] to determine [[Math/Discrete/Number Theory/Modular Arithmetic/Invertibility|invertibility]] using [[The Euclidean Algorithm|the Euclidean algorithm]].
