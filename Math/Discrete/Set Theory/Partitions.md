...
tags:
  ...
  - discrete
---
A *partition* $\mathcal{C}$ of a [[Sets|set]] $A$ is a [[Collections|collection]] of [[Disjoint Sets|disjoint]] [[Subsets|subsets]] of $A$ that cover $A$;
...
> [!definition] The elements of a *partition* are called cells, parts, or blocks.
