...
tags:
  ...
  - discrete
---
A [[Relations|relation]] $\rel$ is a *partial order* [[Logical Equivalence|iff]] **[[Reflexive Property|reflexive]], [[Antisymmetric Property|antisymmetric]], and [[Transitive Property|transitive]]**.
- A *partial order* captures the notion of order. 
- Examples of a *partial order* are:
	- $\le$ on $\R$^[[[The Real Numbers]]].
