...
> $\rel \in A^2$ is [[Symmetric Property|symmetric]] iff there is an [[Inverted Edges|inverted edge]] for every [[Math/Discrete/Graph Theory/Definitions/Edges|edge]].
...
> $\rel \in A^2$ is [[Transitive Property|transitive]] iff, if there is an [[Math/Discrete/Graph Theory/Definitions/Edges|edge]] from $a$ to $b$ and $b$ to $c$, then there is an [[Math/Discrete/Graph Theory/Definitions/Edges|edge]] from $a$ to $c$ (a shortcut).