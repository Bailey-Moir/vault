...
> For example, $\sin$ is [[Injective Functions|one-to-one]] on the [[Intervals|interval]] $\left[ -\dfrac{\pi}{2},\dfrac{\pi}{2} \right]$, so $\sin^{-1}$ is defined with this restriction.
