...
*iff $\it{S}$* *is a [[Vector Bases|basis]] of the solution space of [[Functions|functions]]*.

> [!theorem]- **(1)** $\{ \vecbf{x}_{1}(t),\dots,\vecbf{x}_{n}(t) \}$ is a *FSS* iff $\{ \vecbf{x}_{1}(t_{0}),\dots,\vecbf{x}_{n}(t_{0}) \}$ is a [[Vector Bases|basis]] for $\R^m$ for some $t_{0}$.
> $\left( \implies \right)$
> Suppose $S$ is a *FSS*.
> 
...
> Since every $\vecbf{x}_{0} \in \R^m$ can be written as a **unique** [[Linear Combinations|linear combination]] of $\{ \vecbf{x}_{1}(t_{0}),\dots,\vecbf{x}_{n}(t_{0}) \}$, it must then be a [[Vector Bases|basis]] of $\R^m$.
> 
> $\left( \impliedby \right)$
> Let $\vecbf{x}_{1}(t),\dots,\vecbf{x}_{n}(t)$ solve $\vecbf{x}' = A(t)\vecbf{x}$, and suppose that $\{ \vecbf{x}_{1}(t_{0}),\dots,\vecbf{x}_{n}(t_{0}) \}$ is a [[Vector Bases|basis]] of $\R^m$.
> 
...
> Let $\{ \vecbf{v}_{1},\dots,\vecbf{v}_{m} \}$ be a [[Vector Bases|basis]] for $\R^m$ and choose $\vecbf{x}_{k}(t)$ solve $\vecbf{x}'(t) = A(t)\vecbf{x}(t)$, where
...
> $$\vecbf{x}(t_{0})= c_{1}\vecbf{x}_{1}(t_{0})+\dots+c_{n}\vecbf{x}_{n}(t_{0}) = \vecbf{x}_{0}.$$
> Since every $\vecbf{x}_{0} \in \R^m$ can be written as a **unique** [[Linear Combinations|linear combination]] of $\{ \vecbf{x}_{1}(t_{0}),\dots,\vecbf{x}_{n}(t_{0}) \}$, it must then be a [[Vector Bases|basis]] of $\R^m$, meaning it is of length $m$. Thus, $n = m$.