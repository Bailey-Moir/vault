...
> 
> $\Phi(t)$ is a *fundamental matrix* iff the columns of $\Phi(t)$ are a [[Fundamental Set of Solutions|FSS]], which is true iff the columns of $\Phi(0)$ form a [[Vector Bases|basis]] for $\R^m$, meaning $\Phi(0)$ is [[Matrix Invertibility|invertible]].
> 
...
> 
> The columns of $\Phi(t)$ form a [[Vector Bases|basis]] of the solution [[Vector Spaces|space]], meaning $\Phi(t)$ is [[Injective Functions|injective]].
> 
...
> 
> The [[Dimension|dimension]] of the solution [[Vector Spaces|space]] is $m$[^3], so since the columns of $\Phi(t)$ are a [[Linear Independence|linearly independent]] [[Sets|set]] of [[Vectors|vectors]] in the solution [[Vector Spaces|space]] of length $m$, they must be a [[Vector Bases|basis]] of it[^4].
> 
