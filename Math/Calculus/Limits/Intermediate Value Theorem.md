...
Suppose $f(x)$ is [[Metric Continuity|continuous]] on $\left[a,b\right]$. The *intermediate value theorem* states that for every $y$ in $\left[f(a),f(b)\right]$ or $\left[ f(b),f(a) \right]$, there exists an input in $[a,b]$ that maps to it. 
$$\begin{align}
