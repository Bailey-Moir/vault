...
tags:
  ...
  - math
---
Let $\left( a_{n} \right)_{n=1}^\infty$ and $\left( b_{n} \right)_{n=1}^\infty$ be [[Metric Convergence|convergent sequences]] in $\R$, and let $c \in \R$.
> [!theorem]- **2.6.1** $\left( ca_{n} \right)_{n=1}^\infty$ is [[Metric Convergence|convergent]], and $$\lim(ca_{n})=c\lim a_{n}$$
...
> \end{align}$$
> Thus, the [[Metric Convergence|limit]] of $\left( ca_{n} \right)_{n=1}^\infty$ is $cL = c\lim a_{n}$.

> [!theorem]- **2.6.2** $\left( a_{n} +b_{n} \right)_{n=1}^\infty$ is [[Metric Convergence|convergent]], and $$\lim(a_{n}+b_{n})=\lim a_{n}+\lim b_{n}$$
...
> \end{align}$$
> Thus, for all $\varepsilon > 0$, there exists $N$ such that for all $n \ge N$, $\left| (a_{n}+b_{n}) - \left( L+M \right) \right| < \varepsilon$, meaning the [[Metric Convergence|limit]] of $\left( a_{n}+b_{n} \right)_{n=1}^\infty = L+M$.

> [!theorem]- **2.11** $\left( a_{n}b_{n} \right)_{n=1}^\infty$ is [[Metric Convergence|convergent]], and $$\lim(a_{n}b_{n})=\lim a_{n}\times\lim b_{n}$$
> Since $\left( a_{n} \right)$ is [[Metric Convergence|convergent]], it is [[Bounded Sequences|bounded]][^1]. Thus, there exists $K \in \R$ such that $\left| a_{n} \right| \le K$ for all $n$.
> $$\begin{align}
...
> \end{align}$$
> $\left( a_{n} \right)$ [[Metric Convergence|converges]], so $\lim \left| a_{n}-L \right| = 0$, meaning
> $$\begin{align}
...
> [!note] **2.6** implies [[Metric Convergence|limit of sequences]] is a [[Linear Maps|linear map]].
