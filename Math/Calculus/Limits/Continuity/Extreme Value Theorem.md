...
tags:
  ...
  - math
---
If $f$ is [[Metric Continuity 1|continuous]] on a [[Intervals|closed interval]], then $f$ has a maximum and minimum value on that [[Intervals|interval]].
