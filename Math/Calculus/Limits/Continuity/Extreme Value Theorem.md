...
tags:
  ...
  - math
---
If $f$ is [[Math/Calculus/Limits/Continuity/Continuity|continuous]] on a [[Intervals|closed interval]], then $f$ has a maximum and minimum value on that [[Intervals|interval]].
