...
> [!note]- *Continuity* of [[Intervals|closed and semi-open intervals]] behave slightly differently on their endpoints.
> On a [[Intervals|closed]] endpoint $a$, the corresponding one-sided [[Limits of Real Functions|limit]] must be $f(a)$.