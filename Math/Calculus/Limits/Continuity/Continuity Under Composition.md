...
> [!proof]-
> Let $\varepsilon>0$ be given. By the [[Metric Continuity|continuity]] of $f$ at $g(a)$, there is an $\eta>0$ such that for all $y \in \R$,
> $$\left| y-g(a) \right| < \eta \to \left| f(y) - f(g(a)) \right| < \varepsilon.$$
> Use $\eta$ with the [[Metric Continuity|continuity]] of $f$ to give that there exists $\delta>0$ such that
