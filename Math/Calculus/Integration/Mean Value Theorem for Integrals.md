...
> 
> By the [[Math/Calculus/Limits/Continuity/Continuity|continuity]] of $f$ on $\left[ a,b \right]$, it is [[Bounded Sets|bounded]][^2] and [[Integrability|integrable]][^3], and thus[^4],
> $$\begin{array}{c}
...
[^1]: [[Math/Topology/Continuity/Continuity Under Composition]]
