...
- integrating a [[Metric Continuity|continuous]] [[Functions|function]] over an infinite [[Intervals|interval]], or 
- integrating a [[Functions|function]] that becomes infinite (or has a [[Metric Continuity|discontinuity]]) over a finite [[Intervals|interval]].
...
| [[Metric Continuity\|Continuous]] [[Intervals\|Interval]] | Integral Type                                                                                                                                             |
| ---------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
