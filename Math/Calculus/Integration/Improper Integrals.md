...
- integrating a [[Metric Continuity 1|continuous]] [[Functions|function]] over an infinite [[Intervals|interval]], or 
- integrating a [[Functions|function]] that becomes infinite (or has a [[Metric Continuity 1|discontinuity]]) over a finite [[Intervals|interval]].
...
| [[Metric Continuity 1\|Continuous]] [[Intervals\|Interval]] | Integral Type                                                                                                                                             |
| ---------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
\[[[Metric Continuity 1|Metric Continuity]]\]