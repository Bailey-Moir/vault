...
Suppose $f(x)$ is [[Metric Continuity|continuous]] on $[a,b]$ and [[Differentiation|differentiable]] on $(a,b)$. 
...
> 
> Define $g = f - l$, which is then [[Metric Continuity|continuous]] on $\left[ a,b \right]$ and [[Differentiation|differentiable]] on $\left( a,b \right)$.
> 
