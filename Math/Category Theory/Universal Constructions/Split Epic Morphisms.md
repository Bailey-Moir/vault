...
> [[Categories|Categories]] are [[Duality|self-dual]], and this theorem is dual to [[Split Monic Morphisms#^split-monic-gives-monic|split monic, theorem 1]] which holds for all [[Categories|categories]], so this theorem is given by [[Duality#^statements-in-self-dual-category-classes|duality, theorem 1]].
