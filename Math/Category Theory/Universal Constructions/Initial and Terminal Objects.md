...
tags:
  ...
  - math
---
An object $c$ in a [[Categories|category]] $\mathcal{C}$ is
- *initial* iff $\forall x \in \mathcal{C}: \left|\mathcal{C}(c,x)\right| = 1$, and
- *terminal* iff $\forall x \in \mathcal{C}: \left|\mathcal{C}(x,c)\right| = 1$.
...
> [!theorem]- In any [[Categories|category]], any two *initials* are [[Isomorphisms|isomorphic]], and any two *terminals* are [[Isomorphisms|isomorphic]].
> Let $c$ and $c'$ be both *initials* or *terminals* in a [[Categories|category]] $\mathcal{C}$.
