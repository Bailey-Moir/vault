...
4. Repeat steps 2-4 until the [[Sequences|sequence]] [[Metric Convergence|converges]].

$\vecbf{x}_{0},\vecbf{x}_{1},\dots$ [[Metric Convergence|converges]] to the [[Dominant Eigenvectors & Eigenvalues|dominant eigenvector]] and $m_{0}, m_{1},\dots$ [[Metric Convergence|converges]] to the [[Dominant Eigenvectors & Eigenvalues|dominant eigenvalue]].
