...
> [!theorem]- $A \in \R^{n,n}$ is *orthogonally diagonalisable* iff there is an [[Orthogonal Vectors|orthonormal]] [[Vector Basis|basis]] of $\R^n$ consisting of [[Eigenvectors & Eigenvalues|eigenvectors]] of $A$.
