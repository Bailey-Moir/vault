...
tags:
  ...
  - linear
---
Let $\vecbf{x} \in V$, and suppose $U$ is a [[Subspaces|subspace]] of an [[Inner Products|inner product space]] $V$ with a **[[Orthogonal Vectors|orthogonal]]** [[Vector Bases|basis]] $\vecbf{u}_{1},\dots,\vecbf{u}_{k}$. Then
$$\begin{align}
