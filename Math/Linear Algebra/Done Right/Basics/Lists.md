...
$\mathbb{F}^n$ is the set of all lists of length $n$ with elements of $\mathbb{F}$^[[[Fields]]]:
$$ \mathbb{F}^n = \left\{ \left(x_1, \dots, x_n \right) : x_k \in \mathbb{F} \text{ for } k = 1, \dots,  n \right\} $$
