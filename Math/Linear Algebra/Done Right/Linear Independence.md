...
$$\forall v \in \text{span}(v_1,\dots,v_m), \exists!a_1, \dots, a_m \in \mathbb{F} \ni v = a_1v_1 + \cdots + a_mv_m$$

> [!note] Condition for Linear Independence
> $v_1, \dots, v_m \in V$ is *linearly independent* if the only choice of $a_1, \dots, a_m \in \mathbb{F}$[^1] that makes
