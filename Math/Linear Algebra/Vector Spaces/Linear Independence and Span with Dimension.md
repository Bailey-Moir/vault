...
- Every $I$ can be extended and every $S$ can be reduced to a [[Vector Bases|basis]] of $V$.
  > [!proof]- Reduction
...
- If $\left| I \right|$ or $\left| S \right|$ is equal to $\text{dim}(V)$, it must be a [[Vector Bases|basis]].
  > [!proof]- for $I$
> As shown, $I$ can be extended to a [[Vector Bases|basis]], but since the given [[Lists|list]] is already the size of a [[Vector Bases|basis]], this extension must be trivial, and the [[Lists|list]] must already be a [[Vector Bases|basis]].

  > [!proof]- for $S$
> As shown, $S$ can be reduced to a [[Vector Bases|basis]], but since the given [[Lists|list]] is already the size of a [[Vector Bases|basis]], this reduction must be trivial, and the [[Lists|list]] must already be a [[Vector Bases|basis]].
