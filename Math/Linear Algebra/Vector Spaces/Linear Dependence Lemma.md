...
> \end{align*}$$
> thus $v_{k} \in \span{\vecbf{v}_{1}, \dots, \vecbf{v}_{k-1}}$
> 
> ---
> 
> Now suppose $k$ is any element of $\{ 1,\dots,n \}$ such that $\vecbf{v}_{k} \in \span{ \vecbf{v}_{1}, \dots, \vecbf{v}_{k-1} }$.
> $$\begin{alignat}{4}
> 	&\hspace{0.5em}& \vecbf{v}_{k} &= b_{1}\vecbf{v}_{1} + \dots + b_{k-1}\vecbf{v}_{k-1} &\hspace{1em}& b_{1},\dots,b_{k-1} \in \F \hspace{0.5em}& (1)\\
> 	
> 	\forall \vecbf{u} \in \span{\vecbf{v}_{1}, \dots, \vecbf{v}_{n}} && \vecbf{u} &= c_{1}\vecbf{v}_{1} + \dots + c_{n}\vecbf{v}_{n} && c_{1},\dots,c_{n} \in \F & (2)\\
> \end{alignat}$$
> In the $\text{RHS}$ of (2), $\vecbf{v}_{k}$ can be replaced with the $\text{RHS}$ of (1), meaning 
> $$\span{\vecbf{v}_{1}, \dots, \vecbf{v}_{k-1}, \vecbf{v}_{k+1}, \dots, \vecbf{v}_{n}} = \span{\vecbf{v}_{1}, \dots, \vecbf{v}_{k-1}}$$
