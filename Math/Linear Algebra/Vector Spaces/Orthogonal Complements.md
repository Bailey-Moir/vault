...
\end{align}$$
> [!lemma]
> 1. For a [[Vector Bases|basis]] $\vecbf{u}_{1},\dots,\vecbf{u}_{m}$ of $U$,
...
> > Suppose $\forall i \in \{1,2,\dots,m\}, \left< \vecbf{x},\vecbf{u}_{i} \right> = 0$. Since $\vecbf{u}_{1,}\dots,\vecbf{u}_{m}$ is a [[Vector Bases|basis]] of $U$,
> > $$\begin{align}
...
> 
> > [!proof]- 2
> > For a [[Vector Bases|basis]] $\vecbf{u}_{1},\dots,\vecbf{u}_{m}$ of $U$,
> > $$\begin{align}
...
> 
> > [!proof]- 3
> > The [[Rank|rank]] of $A = \left[ \vecbf{u}_{1} \; \cdots \; \vecbf{u}_{m} \right] ^T$ is $m$ (as $\vecbf{u}_{1}, \dots,\vecbf{u}_{m}$ is a [[Vector Bases|basis]], meaning they are [[Linear Independence|linearly independent]]), which is the [[Dimension|dimension]] of $U$. By [[Rank-Nullity Theorem|rank-nullity theorem]],
> > $$\begin{align}
