...
> 	&\le a_{1}, \\
> \end{align}$$
> so the even terms are [[Bounded Sequences|bounded]], so the even terms must [[Metric Sequence Convergence|converge]] by [[Monotone Convergence Theorem|monotone convergence theorem]].
> 
...
> 	&\ge 0, \\
> \end{align}$$
> so the odd terms are [[Bounded Sequences|bounded]], so the odd terms must [[Metric Sequence Convergence|converge]] by [[Monotone Convergence Theorem|monotone convergence theorem]].
> 
> The odd and even terms must have the same [[Metric Sequence Convergence|limit]] as [[Convergence is a Tail Property|convergence is a tail property]].