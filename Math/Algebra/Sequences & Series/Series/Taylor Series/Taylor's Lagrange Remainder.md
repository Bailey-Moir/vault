...
> Then by the [[Power Rule|power]] and [[Differentiation Rules|chain rule]],and [[Continuity of Differentiable Functions|continuity of differentiable functions]], $g$ is [[Metric Continuity|continuous]] and [[Differentiation|differentiable]] on $\left( a,b \right)$.
> 
> Note that $g(x) = 0$, and
> $$\begin{align}
