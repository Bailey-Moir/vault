...
> Then by the [[Power Rule|power]] and [[Differentiation Rules|chain rule]],and [[Continuity of Differentiable Functions|continuity of differentiable functions]], $g$ is [[Metric Continuity 1|continuous]] and [[Differentiation|differentiable]] on $\left( a,b \right)$.
> 
> Note that $g(x) = 0$, and
> $$\begin{align}
...
> Then similarly, by the [[Power Rule|power]] and [[Differentiation Rules|chain rule]], [[Linearity of Differentiation|linearity of differentiation]], and [[Continuity of Differentiable Functions|continuity of differentiable functions]], $h$ is [[Metric Continuity 1|continuous]] and [[Differentiation|differentiable]] on $\left( a,b \right)$.
> 
> Note that
