...
- It can be shown that $f$ exists as a [[Series|series]] iff $\displaystyle\lim_{n\to\infty} R_n(x) = 0$^[[[Error of Taylor Series]]] for all $x$ in the [[Interval of Convergence|interval of convergence]].