...
The sum of a *power series* is a [[Functions|function]] with a [[Domain|domain]] of the [[Radius of Convergence|interval of convergence]].
...
> For any *power series* on its **radius of convergence**,
