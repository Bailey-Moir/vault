...
> [!theorem] A [[Series|series]] **converges** iff its *partial sums* [[Metric Convergence|converges]] .
...
> 	&\ge S_{n}.
> \end{align}$$
> Thus, the [[Sequences|sequence]] of *partial sums* is [[Monotone Sequences|increasing]]. Since it is also [[Bounded Sequences|bounded]], by [[Monotone Convergence Theorem|monotone convergence theorem]], it must [[Metric Convergence|converge]].