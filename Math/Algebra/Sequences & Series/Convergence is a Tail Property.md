...
tags:
  ...
  - math
---
The [[Metric Convergence|convergence]] and [[Metric Convergence|limit]] of a [[Sequences|sequence]] is unchanged if either
...
> for some $N_{0} \in \N$.
> 
> Suppose $\left( a_{n} \right)$ [[Metric Convergence|converges]].
> 
...
The [[Metric Convergence|convergence]] of a [[Series|series]] is unchanged if either
1. we alter finitely many terms, or
2. we add (or remove) finitely many terms at the beginning.