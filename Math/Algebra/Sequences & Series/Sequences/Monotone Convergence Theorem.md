...
tags:
  ...
  - math
---
All [[Bounded Sequences|bounded]] [[Monotone Sequences|monotone sequences]] [[Metric Convergence|converge]]. Specifically,
...
> 
> Thus, by the first part of this proof, $b_{n}$ [[Metric Convergence|converges]] to its [[Supremums and Infimums|supremum]], which gives that $a_{n}$ [[Metric Convergence|converges]] to its [[Supremums and Infimums|infimum]].
...
> [!extended-version] All [[Monotone Sequences|monotone sequences]] [[Metric Convergence|converge]] iff they are [[Bounded Sequences|bounded]]