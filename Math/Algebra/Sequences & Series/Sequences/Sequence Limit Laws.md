...
tags:
  ...
  - math
---
Let $\left( a_{n} \right)_{n=1}^\infty$ and $\left( b_{n} \right)_{n=1}^\infty$ be [[Sequence Convergence|convergent sequences]], and let $c \in \R$.
> [!theorem]- **2.6.1** $\left( ca_{n} \right)_{n=1}^\infty$ is [[Sequence Convergence|convergent]], and $$\lim(ca_{n})=c\lim a_{n}$$
...
> [!theorem]- **2.6.2** $\left( a_{n} +b_{n} \right)_{n=1}^\infty$ is [[Sequence Convergence|convergent]], and $$\lim(a_{n}+b_{n})=\lim a_{n}+\lim b_{n}$$
...
> [!theorem]- **2.11** $\left( a_{n}b_{n} \right)_{n=1}^\infty$ is [[Sequence Convergence|convergent]], and $$\lim(a_{n}b_{n})=\lim a_{n}\times\lim b_{n}$$
> Since $\left( a_{n} \right)$ is [[Sequence Convergence|convergent]], it is [[Bounded Sequences|bounded]][^1]. Thus, there exists $K \in \R$ such that $\left| a_{n} \right| \le K$ for all $n$.
> $$\begin{align}
...
> \end{align}$$
> $\left( a_{n} \right)$ [[Sequence Convergence|converges]], so $\lim \left| a_{n}-L \right| = 0$, meaning
> $$\begin{align}
...
> [!note] **2.6** implies [[Sequence Convergence|limit of sequences]] is a [[Linear Maps|linear map]].
