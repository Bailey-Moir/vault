...
> Suppose that $a_{n} = r^n$ has a [[Metric Convergence|limit]] of $L$.
> 
...
> 
> Thus, $\left( r^n \right)$ is a [[Monotone Sequences|decreasing sequence]] that is [[Bounded Sequences|bounded below]] (by $0$), so the [[Metric Convergence|sequence converges]].
> 
> The [[Metric Convergence|convergence]] gives $L = rL$, and since $r \ne 1$, $L = 0$.
> 
> **Case** $\mathbf{-1 < r < 0}$
> Thus $0 < \left| r \right| < 1$, hence $\lim \left| r \right|^n = 0$ by the first case.
> 
> But $\left| r^n \right| = \left| r \right|^n$, and since [[Absolute Values|absolute values]] are just multiplying by constants, $r^n$ must also [[Metric Convergence|converge]].
> 
...
> 
> If $\left| r \right| > 1$ and $r^n$ [[Metric Convergence|converges]], since $r \ne 1$ its [[Metric Convergence|limit]] must be $L = 0$.
> 
> But $\left| r^n \right| > 1$, so $r^n$ cannot [[Metric Convergence|converge]] to $0$.