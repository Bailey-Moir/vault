...
tags:
  ...
  - math
---
Extending [[Sequences|sequences]] to [[Metric Continuity|continuous]] [[Functions|functions]] over the [[The Real Numbers|real]] numbers allows for use of calculus techniques to infer information about the original [[Sequences|sequence]]. 

Let $f$ be a [[Metric Continuity|continuous]] extension of some [[Sequences|sequence]] $\left\{a_n\right\}_{n=1}^\infty$ into the [[The Real Numbers|real]] numbers. Note that the below inferences are only [[Logical Implication|one way implications]].
