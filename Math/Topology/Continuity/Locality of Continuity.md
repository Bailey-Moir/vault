...
> By the [[Continuity|continuity]] of $f\bigr|_{U}$, $f^{-1}\bigr|_{U}(V)$ is a [[Open Sets|open]] [[Subsets|subset]] of $f^{-1}(V)$ containing $p$. Thus, by the [[Interiors|characterisation of interiors]], $p \in \text{int}\left( f^{-1}(V) \right)$.
> 
