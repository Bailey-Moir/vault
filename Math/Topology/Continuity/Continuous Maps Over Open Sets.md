...
tags:
  ...
  - math
---
If $f : X\to Y$ is [[Continuity|continuous]] and $U \in \mathcal{T}_{X}$, then $f \bigr|_{U} : U \to Y$ is [[Continuity|continuous]];
$$\forall f \in \mathcal{C}_{X}^Y, \forall U \in \mathcal{T}_{X}, f \bigr|_{U} \in \mathcal{C}_{U}^Y$$
> [!proof]-
> Let $V \in \mathcal{T}_{Y}$. By the [[Continuity|continuity]] of $f$, $f^{-1}(V) \in \mathcal{T}_{X}$.
> 
