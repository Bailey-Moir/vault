...
> [!theorem]- **2.8** If $\left( a_{n} \right)$ is [[Metric Convergence|convergent]], then it is *bounded*
> Since $\left( a_{n} \right)$ is [[Metric Convergence|convergent]], $\forall \varepsilon > 0, \exists N : \forall n \ge N, \left| a_{n} - L \right| < \varepsilon$.
> 
